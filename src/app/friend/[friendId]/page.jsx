  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      const res = await fetch(
        "https://my-kinkeeper-project-nextjs.vercel.app/friends.json",
      );
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6 w-10/12 mx-auto">
        <div className="md:col-span-4 space-y-6">
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 text-center">
            ...
            <div className="flex justify-center gap-2 my-3">
              <span
                className={`px-4 py-1 rounded-full text-white text-xs font-medium capitalize ${
        ...
        <main className="md:col-span-8 space-y-6">
          ...
          <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 relative">
            ...
            <button className="absolute top-6 right-6 px-4 py-1 border rounded-lg text-sm hover:bg-gray-50">
              Edit
            </button>
          </div>
          ...
          <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
            ...
            <div className="grid grid-cols-3 gap-4">
              <button
                onClick={() => handaletimeline("Call")}
                className="flex flex-col items-center p-6 bg-gray-50 rounded-xl hover:bg-base-200 hover  transition"
              >
                <Image
                  src="/call.png"
                  alt="Call"
